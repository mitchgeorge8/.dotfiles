...
do
	...
	(crontab -l 2>/dev/null; echo "${calc_sunrise: -2} ${calc_sunrise::-2} * * * ddcutil setvcp 10 $brightness; hyprctl hyprsunset temperature $temperature") | crontab -
done
...
do
	...
	(crontab -l 2>/dev/null; echo "${calc_sunset: -2} ${calc_sunset::-2} * * * ddcutil setvcp 10 $brightness; hyprctl hyprsunset temperature $temperature") | crontab -
done
